...
# ---------------------------------------------------------------- HEADER
HEADER = u'''<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 840 200" width="840" height="200" role="img" aria-label="Gabriel Chiarelli — Backend Developer">
<style>
  .ink   {{ fill: {ink}; }}
  .mut   {{ fill: {mut}; }}
...
<text class="ink sub"  x="40" y="146">BACKEND  ·  INTEGRATIONS  ·  SYSTEM ARCHITECTURE</text>
